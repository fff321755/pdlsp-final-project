...
python hm.py --seed 42 --model O \
--train traindev --valid dev_seen --test test_seen,test_unseen --lr 1e-5 --batchSize 8 --tr bert-large-uncased --epochs 3 --tsv \
--num_features 36 --loadpre ./data/LAST_BO.pth --contrib --exp O36 --topk $topk

# Simple Average
python utils/ens.py --enspath ./data/ --enstype sa --exp O36